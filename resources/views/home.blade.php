...
<!-- @section('canonical_url', url()->full()) -->


<div class="slider-area">
    <div class="slider-full-active owl-carousel custom-dots">
        <div class="slide-full slider-height d-flex align-items-center" style="background-image: url(public/assets/img/hero/h1_hero.png);">
            <div class="container">
                <div class="row">
        ...
        <div class="slide-full d-flex slider-height align-items-center" style="background-image: url(public/assets/img/hero/h1_hero2.png);">
            <div class="container">
                <div class="row">
        ...
        <div class="slide-full d-flex slider-height align-items-center" style="background-image: url(public/assets/img/hero/h1_hero.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-8 col-md-7 col-sm-8">
                        <div class="slide-full-content">
        ...
        <div class="row">
            <div class="col-xl-col-lg-6 col-md-6 col-sm-6">
                <div class="single-cat mb-110">
                    <img src="{{asset('public/assets/img/gallery/popular1.png')}}" alt="">
                    <div class="img-cap">
            ...
            <div class="col-xl-col-lg-6 col-md-6 col-sm-6">
                <div class="single-cat mb-110">
                    <img src="{{asset('public/assets/img/gallery/popular2.png')}}" alt="">
                    <div class="img-cap">
            ...
            <div class="col-xl-col-lg-6 col-md-6 col-sm-6">
                <div class="single-cat mb-110">
                    <img src="{{asset('public/assets/img/gallery/popular3.png')}}" alt="">
                    <div class="img-cap">
            ...
            <div class="col-xl-col-lg-6 col-md-6 col-sm-6">
                <div class="single-cat mb-110">
                    <img src="{{asset('public/assets/img/gallery/popular4.png')}}" alt="">
                    <div class="img-cap">
                        <h4>Downside Low House</h4>
                        <p>Melbourn, Australia</p>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{asset('public/assets/img/gallery/home-blog1.png')}}" alt="">
                            <!-- Blog date -->
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{asset('public/assets/img/gallery/home-blog2.png')}}" alt="">
                            <!-- Blog date -->
                            <div class="blog-date text-center">
                                <span>24</span>
                                <p>Now</p>
